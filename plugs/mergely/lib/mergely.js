! function(t, e) {
    ...
    return function(t) {
            ...
            s.DiffParser = function(t) {
                for (var e = [], i = 0, r = t.split(/\n/), n = 0; n < r.length; ++n)
                    if (0 != r[n].length) {
                        ...
                        if (null != o) {
                            var l = o[1].split(",");
                            h["lhs-line-from"] = l[0] - 1, 1 == l.length ? h["lhs-line-to"] = l[0] - 1 : h["lhs-line-to"] = l[1] - 1;
                            var a = o[3].split(",");
                            h["rhs-line-from"] = a[0] - 1, 1 == a.length ? h["rhs-line-to"] = a[0] - 1 : h["rhs-line-to"] = a[1] - 1, h.op = o[2], e[i++] = h
                        }
                    }
                return e
            }, s.sizeOf = function(t) {
                ...
                diff: function(t, e) {
                    for (var i = new s.diff(this.x, this.y, {
                        ...
                        var l = r[o];
                        if ("a" != l.op) {
                            n = i.getLines("lhs").slice(0, l["lhs-line-from"]).join(" ").length, h = l["lhs-line-to"] + 1;
                            var a = i.getLines("lhs").slice(l["lhs-line-from"], h).join(" ");
                            "d" == l.op ? a += " " : n > 0 && "c" == l.op && (n += 1), e(n, n + a.length)
                        }
                        if ("d" != l.op) {
                            n = i.getLines("rhs").slice(0, l["rhs-line-from"]).join(" ").length, h = l["rhs-line-to"] + 1;
                            var c = i.getLines("rhs").slice(l["rhs-line-from"], h).join(" ");
                            "a" == l.op ? c += " " : n > 0 && "c" == l.op && (n += 1), t(n, n + c.length)
                        }
                    }
                }
            }), s.CodeifyText = function(e) {
                this._max_code = 0, this._diff_codes = {}, this.ctxs = {}, t.extend(this, e), this.lhs = e.lhs.split("\n"), this.rhs = e.rhs.split("\n")
                ...
                _codeify: function(t, e) {
                    ...
                    for (var i = 0; i < t.length; ++i) {
                        var s = t[i];
                        this.options.ignorews && (s = s.replace(/\s+/g, "")), this.options.ignorecase && (s = s.toLowerCase()), this.options.ignoreaccents && (s = s.normalize("NFD").replace(/[\u0300-\u036f]/g, ""));
                ...
                h.codes.length, o.codes.length;
                this._lcs(h, 0, h.codes.length, o, 0, o.codes.length, [], []), this._optimize(h), this._optimize(o), this.items = this._create_diffs(h, o)
                ...
                _lcs: function(t, e, i, s, r, n, h, o) {
                    ...
                    if (e == i)
                        ...
                        this._lcs(t, e, l.x, s, r, l.y, h, o), this._lcs(t, l.x, i, s, l.y, n, h, o)
                    }
                },
                _sms: function(t, e, i, s, r, n, h, o) {
                    ...
                    for (p = 0; p <= u; ++p) {
                        for (m = a - p; m <= a + p; m += 2) {
                            for (m == a - p ? _ = o[g + m + 1] : (_ = o[g + m - 1] + 1, m < a + p && o[g + m + 1] >= _ && (_ = o[g + m + 1])), v = _ - m; _ < i && v < n && t.codes[_] == s.codes[v];) _++, v++;
                            if (o[g + m] = _, d && c - p < m && m < c + p && h[f + m] <= o[g + m]) return y.x = o[g + m], y.y = o[g + m] - m, y
                        }
                        for (m = c - p; m <= c + p; m += 2) {
                            for (m == c + p ? _ = h[f + m - 1] : (_ = h[f + m + 1] - 1, m > c - p && h[f + m - 1] < _ && (_ = h[f + m - 1])), v = _ - m; _ > e && v > r && t.codes[_ - 1] == s.codes[v - 1];) _--, v--;
                            if (h[f + m] = _, !d && a - p <= m && m <= a + p && h[f + m] <= o[g + m]) return y.x = o[g + m], y.y = o[g + m] - m, y
                        }
                    }
                ...
                _create_diffs: function(t, e) {
                    for (var i = [], s = 0, r = 0, n = 0, h = 0; n < t.codes.length || h < e.codes.length;)
                        if (n < t.codes.length && !t.modified[n] && h < e.codes.length && !e.modified[h]) n++, h++;
                        else {
                            for (s = n, r = h; n < t.codes.length && (h >= e.codes.length || t.modified[n]);) n++;
                            for (; h < e.codes.length && (n >= t.codes.length || e.modified[h]);) h++;
                            (s < n || r < h) && i.push({
                                lhs_start: s,
                                rhs_start: r,
                ...
                name: "mergely",
                init: function(t, e) {
                    this.diffView = new s.CodeMirrorDiffView(t, e), this.bind(t)
                },
                bind: function(t) {
                ...
                init: function(e, i) {
                    this.settings = t.extend(!0, {
                        ...
                        _debug: "",
                        resized: function() {}
                    }, i), this.element = t(e), this.lhs_cmsettings = {
                    ...
                    var r = [];
                    this.rhs_cmsettings.lineNumbers && (r = ["merge", "CodeMirror-linenumbers"]), t.extend(!0, this.lhs_cmsettings, this.settings.cmsettings, {
                        gutters: s
                    }, this.settings.lhs_cmsettings), t.extend(!0, this.rhs_cmsettings, this.settings.cmsettings, {
                        gutters: r
                    }, this.settings.rhs_cmsettings), this.element.bind("destroyed", t.proxy(this.teardown, this)), t.data(e, "mergely", this), this._setOptions(i)
                },
                unbind: function() {
                    null != this.changed_timeout && clearTimeout(this.changed_timeout), this.editor[this.id + "-lhs"].toTextArea(), this.editor[this.id + "-rhs"].toTextArea(), t(window).off(".mergely")
                },
                destroy: function() {
                ...
                lhs: function(t) {
                    this.changes = [], this.editor[this.id + "-lhs"].setValue(t)
                },
                rhs: function(t) {
                    this.changes = [], this.editor[this.id + "-rhs"].setValue(t)
                },
                update: function() {
                ...
                _setOptions: function(e) {
                    if (t.extend(this.settings, e), this.settings.hasOwnProperty("rhs_margin"))
                        if ("left" == this.settings.rhs_margin) this.element.find(".mergely-margin:last-child").insertAfter(this.element.find(".mergely-canvas"));
                        else {
                    ...
                    this.settings.hasOwnProperty("sidebar") && (this.settings.sidebar ? this.element.find(".mergely-margin").css({
                        ...
                        display: "none"
                    })), this.settings.hasOwnProperty("wrap_lines") && this.editor && (s = this.editor[this.id + "-lhs"], r = this.editor[this.id + "-rhs"], s.setOption("lineWrapping", this.settings.wrap_lines), r.setOption("lineWrapping", this.settings.wrap_lines)), this.settings.hasOwnProperty("line_numbers") && this.editor && (s = this.editor[this.id + "-lhs"], r = this.editor[this.id + "-rhs"], s.setOption("lineNumbers", this.settings.line_numbers), r.setOption("lineNumbers", this.settings.line_numbers))
                },
                options: function(t) {
                ...
                search: function(t, e, i) {
                    ...
                    i = "prev" == i ? "findPrevious" : "findNext", 0 != (s = "lhs" == t ? r : n).getSelection().length && this.prev_query[t] == e || (this.cursor[this.id] = s.getSearchCursor(e, {
                        line: 0,
                        ch: 0
                ...
                resize: function() {
                    this.settings.resize(), this._changing(this.id + "-lhs", this.id + "-rhs"), this._set_top_offset(this.id + "-lhs")
                },
                diff: function() {
                ...
                bind: function(i) {
                    var s, r, n = this;
                    this.trace("init", "bind"), this.element.hide(), this.id = t(i).attr("id");
                    try {
                        t("#".concat(this.id))
                    } catch (t) {
                        return void console.error("jQuery failed to find mergely: #".concat(this.id))
                    }
                    if (this.changed_timeout = null, this.chfns = {}, this.chfns[this.id + "-lhs"] = [], this.chfns[this.id + "-rhs"] = [], this.prev_query = [], this.cursor = [], this._skipscroll = {}, this.change_exp = new RegExp(/(\d+(?:,\d+)?)([acd])(\d+(?:,\d+)?)/), null != t.button) s = '<button title="Merge left"></button>', r = '<button title="Merge right"></button>';
                    else {
                        var h = "opacity:0.6;background-color:#1F4589;cursor:pointer;text-align:center;color:#eee;margin-right:-15px;";
                        s = '<div style="' + h + '" title="Merge left">&lt;</div>', r = '<div style="' + h + '" title="Merge right">&gt;</div>'
                    }
                    this.merge_rhs_button = t(r), this.merge_lhs_button = t(s);
                    ...
                    a.eq(0).attr("id", "".concat(this.id, "-editor-lhs")), a.find("#text-lhs").attr("id", "".concat(this.id, "-lhs"));
                    ...
                    c.find("#mergely-canvas").attr("id", "".concat(this.id, "-mergely-canvas")), c.find("#lhs-rhs-canvas").attr("id", "".concat(this.id, "-lhs-").concat(this.id, "-rhs-canvas")), this.element.append(o), this.element.append(l), this.element.append(a), this.element.append(c);
                    var d = t('<div class="mergely-margin" style="height: \''.concat("10px", '\'"><canvas id="rhs-margin" width="8px" height="\'').concat("10px", "'\"></canvas></div>"));
                    d.find("#rhs-margin").attr("id", "".concat(this.id, "-rhs-margin")), "left" == this.settings.rhs_margin && this.element.append(d);
                    ...
                    if (g) {
                        ...
                        if (_) {
                            ...
                            this.settings.autoresize && (y += "".concat(this.id, " .CodeMirror-scroll { height: 100%; overflow: auto; }")), t('<style type="text/css">'.concat(y += "\n.CodeMirror { line-height: 18px; }", "</style>")).appendTo("head");
                            var w = this;
                            if (w.trace("init", "binding event listeners"), this.editor = [], this.editor[this.id + "-lhs"] = e.fromTextArea(_, this.lhs_cmsettings), this.editor[this.id + "-rhs"] = e.fromTextArea(g, this.rhs_cmsettings), this.editor[this.id + "-lhs"].on("change", (function() {
                                ...
                                var b = null,
                                    x = function(t) {
                                        w.settings.resize && w.settings.resize(t), w.editor[w.id + "-lhs"].refresh(), w.editor[w.id + "-rhs"].refresh()
                                    };
                            ...
                            this.editor[this.id + "-lhs"].on("gutterClick", function(t, e, i, s) {
                                ...
                                this._initializing = !0, this.editor[this.id + "-lhs"].getDoc().setValue(t)
                            }.bind(this))), this.settings.rhs && (w.trace("init", "setting rhs value"), this.settings.rhs(function(t) {
                                this._initializing = !0, this.editor[this.id + "-rhs"].getDoc().setValue(t)
                            }.bind(this))), this.element.one("updated", (function() {
                                n._initializing = !1, w.settings.loaded && w.settings.loaded()
                    ...
                    function C(e, i, s) {
                        var r, n;
                        if (!(s.target && t(s.target).closest(".merge-button").length > 0))
                            for (r = 0; r < this.changes.length; r++)
                                if (i >= (n = this.changes[r])[e + "-line-from"] && i <= n[e + "-line-to"]) {
                                    this._current_diff = r, setTimeout(function() {
                                        this.scrollToDiff()
                                    }.bind(this), 10);
                                    break
                                }
                    ...
                    if (!0 !== this._skipscroll[e]) {
                        if (this.changes) {
                            ...
                            var s = this.editor[e].coordsChar({
                                ...
                                n = i.scrollTop(),
                                h = i.scrollLeft();
                            this.trace("scroll", "side", e), this.trace("scroll", "midway", this.midway), this.trace("scroll", "midline", s), this.trace("scroll", "top_to", n), this.trace("scroll", "left_to", h);
                            var o = this.id + "-lhs",
                                l = this.id + "-rhs";
                            for (var a in this.editor)
                                if (this.editor.hasOwnProperty(a) && e != a) {
                ...
                _changing: function(t, e) {
                    ...
                    null != this.changed_timeout && clearTimeout(this.changed_timeout), this.changed_timeout = setTimeout((function() {
                        r.start(), i._changed(t, e), i.trace("change", "total time", r.stop())
                ...
                _clear: function() {
                    var t, e, i, s, n, h, o = this,
                        l = function() {
                            ...
                            for (s = 0; s < i.length; ++s)(n = i[s]).lines.length && o.trace("change", "clear text", n.lines[0].text), n.clear();
                            e.clearGutter("merge"), o.trace("change", "clear time", r.stop())
                        };
                ...
                _diff: function(t, e) {
                    ...
                    this.trace("change", "diff time", r.stop()), this.changes = s.DiffParser(h.normal_form()), this.trace("change", "parse time", r.stop()), void 0 === this._current_diff && this.changes.length && (this._current_diff = 0, this._initializing && (console.log("init"), this._scroll_to_change(this.changes[0]))), this.trace("change", "scroll_to_change time", r.stop()), this._calculate_offsets(t, e, this.changes), this.trace("change", "offsets time", r.stop()), this._markup_changes(t, e, this.changes), this.trace("change", "markup time", r.stop()), this._draw_diff(t, e, this.changes), this.trace("change", "draw time", r.stop()), this.element.trigger("updated")
                },
                _parse_diff: function(t, e, i) {
                    ...
                    for (var s = [], r = 0, n = i.split(/\n/), h = 0; h < n.length; ++h)
                        if (0 != n[h].length) {
                            ...
                            if (null != l) {
                                var a = l[1].split(",");
                                o["lhs-line-from"] = a[0] - 1, 1 == a.length ? o["lhs-line-to"] = a[0] - 1 : o["lhs-line-to"] = a[1] - 1;
                                var c = l[3].split(",");
                                o["rhs-line-from"] = c[0] - 1, 1 == c.length ? o["rhs-line-to"] = c[0] - 1 : o["rhs-line-to"] = c[1] - 1, o["lhs-line-from"] < 0 && (o["lhs-line-from"] = 0), o["lhs-line-to"] < 0 && (o["lhs-line-to"] = 0), o["rhs-line-from"] < 0 && (o["rhs-line-from"] = 0), o["rhs-line-to"] < 0 && (o["rhs-line-to"] = 0), o.op = l[2], s[r++] = o, this.trace("diff", "change", o)
                            }
                        }
                    return s
                },
                ...
                _calculate_offsets: function(e, i, s) {
                    if (null == this.em_height) {
                        ...
                        this.em_height = this.editor[e].defaultTextHeight(), this.em_height || (console.warn("Failed to calculate offsets, using 18 by default"), this.em_height = 18), this.draw_lhs_min = .5;
                        var r = t("#" + e + "-" + i + "-canvas");
                        if (r.length || console.error("failed to find canvas", "#" + e + "-" + i + "-canvas"), !r.width()) return void console.error("canvas width is 0");
                        this.draw_mid_width = t("#" + e + "-" + i + "-canvas").width(), this.draw_rhs_max = this.draw_mid_width - .5, this.draw_lhs_width = 5, this.draw_rhs_width = 5, this.trace("calc", "change offsets calculated", {
                ...
                _markup_changes: function(e, i, n) {
                    ...
                    r.start(), o.operation(function() {
                        for (var t = 0; t < n.length; ++t) {
                            ...
                            if (this._is_change_in_view("lhs", c, e)) {
                                ...
                                if (o.addLineClass(i, "background", "start"), o.addLineClass(s, "background", "end"), e["lhs-line-from"] < 0 && d.push("empty"), a == t && (i != s && o.addLineClass(i, "background", "current"), o.addLineClass(s, "background", "current")), 0 == i && 0 == s && 0 == r) o.addLineClass(i, "background", d.join(" ")), o.addLineClass(i, "background", "first");
                                else
                                    for (var g = i; g <= s; ++g) o.addLineClass(g, "background", d.join(" ")), o.addLineClass(g, "background", d.join(" "));
                                if (!l.getOption("readOnly")) {
                                    ...
                                    f.button && f.button({
                                        ...
                                        text: !1
                                    }), f.addClass("merge-button"), f.attr("id", "merge-rhs-" + t), o.setGutterMarker(i, "merge", f.get(0))
                                }
                            }
                        }
                    }.bind(this)), this.trace("change", "markup lhs-editor time", r.stop()), l.operation(function() {
                        for (var t = 0; t < n.length; ++t) {
                            var e = n[t];
                            if (this._is_change_in_view("rhs", d, e)) {
                                ...
                                if (l.addLineClass(s, "background", "start"), l.addLineClass(r, "background", "end"), e["rhs-line-from"] < 0 && c.push("empty"), a == t && (s != r && l.addLineClass(s, "background", "current"), l.addLineClass(r, "background", "current")), 0 == s && 0 == r && 0 == i) l.addLineClass(s, "background", c.join(" ")), l.addLineClass(s, "background", "first");
                                else
                                    for (var g = s; g <= r; ++g) l.addLineClass(g, "background", c.join(" ")), l.addLineClass(g, "background", c.join(" "));
                                if (!o.getOption("readOnly")) {
                                    ...
                                    f.button && f.button({
                                        ...
                                        text: !1
                                    }), f.addClass("merge-button"), f.attr("id", "merge-lhs-" + t), l.setGutterMarker(s, "merge", f.get(0))
                                }
                            }
                        }
                    }.bind(this)), this.trace("change", "markup rhs-editor time", r.stop());
                    var g, f = [];
                    for (L = 0; this.settings.lcs && L < n.length; ++L) {
                        ...
                        if ("d" == u.op) {
                            ...
                            for (k = p, g = _; k >= 0 && k <= m || g >= 0 && g <= v; ++k, ++g) {
                                var x, C;
                                if (g > v) x = o.getLine(k), f.push([o, {
                                    line: k,
                                    ch: 0
                                }, {
                                    line: k,
                                ...
                                else if (k > m) C = l.getLine(g), f.push([l, {
                                    line: g,
                                    ch: 0
                                }, {
                                    line: g,
                                ...
                                else x = o.getLine(k), C = l.getLine(g), new s.LCS(x, C, {
                    ...
                    this.trace("change", "LCS marktext time", r.stop()), o.operation((function() {
                    ...
                    this.element.find(".merge-button").on("click", (function(e) {
                        ...
                        t.each(o.bgClass.split(" "), (function(t, e) {
                            if (0 == e.indexOf("cid-")) return n = parseInt(e.split("-")[1], 10), !1
                        }));
                        var l = h.changes[n];
                        return h._merge_change(l, i, s), !1
                    }));
                    ...
                    T.removeClass("mergely current"), P.removeClass("mergely current");
                    ...
                    for (L = 0; L < n.length; ++L) {
                        if (u = n[L], a == L && "a" !== u.op)
                            for (M = u["lhs-line-from"], O = u["lhs-line-to"] + 1, k = M; k < O; ++k) k >= S && k <= E && P.eq(k - S).addClass("mergely current");
                        if (a == L && "d" !== u.op)
                            for (M = u["rhs-line-from"], O = u["rhs-line-to"] + 1, k = M; k < O; ++k) k >= V && k <= j && T.eq(k - V).addClass("mergely current")
                    }
                ...
                _draw_diff: function(e, i, s) {
                    ...
                    for (var c = this._get_viewport_side(e), d = this._get_viewport_side(i), g = 0; g < s.length; ++g) {
                        ...
                        this._current_diff === g && (u = this.current_diff_color), this.trace("draw", f);
                        ...
                        if (this.trace("draw", "marker calculated", p, m, _, v), l.beginPath(), l.fillStyle = u, l.strokeStyle = "#000", l.lineWidth = .5, l.fillRect(1.5, p, 4.5, Math.max(m - p, 5)), l.strokeRect(1.5, p, 4.5, Math.max(m - p, 5)), a.beginPath(), a.fillStyle = u, a.strokeStyle = "#000", a.lineWidth = .5, a.fillRect(1.5, _, 4.5, Math.max(v - _, 5)), a.strokeRect(1.5, _, 4.5, Math.max(v - _, 5)), this._is_change_in_view("lhs", c, f) || this._is_change_in_view("rhs", d, f)) {
                            p = f["lhs-y-start"], m = f["lhs-y-end"], _ = f["rhs-y-start"], v = f["rhs-y-end"];
                            o.beginPath(), o.strokeStyle = u, o.lineWidth = this._current_diff == g ? 1.5 : 1;
                            var y = this.draw_lhs_width,
                                w = m - p - 1,
                                b = this.draw_lhs_min,
                                x = p;
                            o.moveTo(b, x), "Microsoft Internet Explorer" == navigator.appName ? (o.lineTo(this.draw_lhs_min + this.draw_lhs_width, p), o.lineTo(this.draw_lhs_min + this.draw_lhs_width, m + 1), o.lineTo(this.draw_lhs_min, m + 1)) : (w <= 0 ? o.lineTo(b + y, x) : (o.arcTo(b + y, x, b + y, x + 3, 3), o.arcTo(b + y, x + w, b + y - 3, x + w, 3)), o.lineTo(b, x + w)), o.stroke(), y = this.draw_rhs_width, w = v - _ - 1, b = this.draw_rhs_max, x = _, o.moveTo(b, x), "Microsoft Internet Explorer" == navigator.appName ? (o.lineTo(this.draw_rhs_max - this.draw_rhs_width, _), o.lineTo(this.draw_rhs_max - this.draw_rhs_width, v + 1), o.lineTo(this.draw_rhs_max, v + 1)) : (w <= 0 ? o.lineTo(b - y, x) : (o.arcTo(b - y, x, b - y, x + 3, 3), o.arcTo(b - y, x + w, b - 3, x + w, 3)), o.lineTo(b, x + w)), o.stroke();
                            var C = this.draw_lhs_min + this.draw_lhs_width,
                                A = p + (m + 1 - p) / 2,
                                M = this.draw_rhs_max - this.draw_rhs_width,
                                O = _ + (v + 1 - _) / 2;
                            o.moveTo(C, A), A == O ? o.lineTo(M, O) : o.bezierCurveTo(C + 12, A - 3, M - 12, O - 3, M, O), o.stroke()
                        }
                    }
        ...
        var s = function() {
            ...
            }], (s = null) && i(e.prototype, s), r && i(e, r), t
        }();
        s.t0 = 0, t.exports = s
    }, function(e, i) {
        e.exports = t
